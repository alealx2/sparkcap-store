...
import {linkSocialType} from './objects/link/linkSocialType'
...
const annotations = [linkEmailType, linkExternalType, linkInternalType, linkProductType, linkSocialType]
...
import {storeInfoType} from './singletons/storeInfoType'

const singletons = [homeType, settingsType, storeInfoType]
